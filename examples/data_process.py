import json
input_file = "data/alime/test.txt"
output_file_seg = "data/alime/test_seg.txt"
cut_list_file = "data/alime/cutlist_test.json"

final_outputfile="data/alime/testseg.txt"
interval = 10
